#include <Vis_o_Computacional_inferencing.h>
...
void loop() {
  ...
  if(result.classification[2].value > result.classification[0].value && result.classification[2].value > result.classification[1].value && result.classification[2].value > result.classification[3].value){
    digitalWrite(D1, LOW);
    digitalWrite(D2, HIGH);
    digitalWrite(D3, LOW);
  }
  if(result.classification[3].value > result.classification[0].value && result.classification[3].value > result.classification[2].value && result.classification[3].value > result.classification[1].value){
    digitalWrite(D1, HIGH);
    digitalWrite(D2, LOW);
    digitalWrite(D3, HIGH);
  }
